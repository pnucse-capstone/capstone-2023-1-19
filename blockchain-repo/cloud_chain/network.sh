...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.pnu.cse docker_peer0.org1.pnu.cse docker_peer0.org2.pnu.cse
    ...
    ${CONTAINER_CLI} run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/inspector/msp organizations/fabric-ca/inspector/tls-cert.pem organizations/fabric-ca/inspector/ca-cert.pem organizations/fabric-ca/inspector/IssuerPublicKey organizations/fabric-ca/inspector/IssuerRevocationPublicKey organizations/fabric-ca/inspector/fabric-ca-server.db'
